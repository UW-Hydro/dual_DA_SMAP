...
%             > 0*1e-3 && sqrt(var(smd_observed((smd_observed >=0)))) > 0*1e-3) 
        ...
        [sum_rain_corrected, sum_rain_corrected_ens, optimized_fraction] = ...
            correction(increment_sum,increment_sum_hold,increment_sum_ens, sum_rain_sp,sum_rain_sp2,lambda_flag, filter_flag, NUMEN, rain_perturbed_sum_ens, lambda_tuning_target);
